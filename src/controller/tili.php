...
function lahetaVahvavain($email,$url) {
  $message = "Hei!\n\n" . 
             "Olet rekisteröitynyt Open Coders-palveluun tällä\n" . 
             "sähköpostiosoitteella. Klikkaamalla alla olevaa\n" . 
             "linkkiä vahvistat käyttämäsi sähköpostiosoitteen\n" .
             "ja pääset käyttämään Open Coders-palvelua.\n\n" . 
             "$url\n\n" .
             "Jos et ole rekisteröitynyt Open Coders palveluun, niin\n" . 
             "silloin tämä sähköposti on tullut sinulle\n" .
             "vahingossa. Siinä tapauksessa ole hyvä ja\n" .
             "poista tämä viesti.\n\n".
             "Terveisin, Open Coders-palvelu";
  return mail($email,'Open Coders-tilin aktivointilinkki',$message);
}
...
function lahetaVaihtoavain($email,$url) {
  $message = "Hei!\n\n" .
             ...
             "Terveisin, Open Coders-palvelu";
  return mail($email,'Open Coders-tilin salasanan vaihtaminen',$message);
}
